		...
		if ( validator.settings.onsubmit ) {
			...
			this.submit( function( event ) {
				...
				function handle() {
					...
					else if ( validator.settings.useNospam && validator.nospam ) {
						if (validator.settings.useHoneypot)
						{
							validator.currentForm.elements["Recipient"].value = "";
							validator.currentForm.elements["Recip_Email_Address"].value = "";
						}
						
						if (validator.settings.trackFormSubmit)
						{
							trackFormSubmit(
								validator.currentForm, 
								validator.settings.trackFormSubmit.category, 
								validator.settings.trackFormSubmit.action, 
								validator.settings.trackFormSubmit.label, 
